                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 calls-to-action hidden-sm hidden-xs">
                                        <c:if test="${loggedIn == 'FALSE'}">
                                            <a class="btn btn-sm btn-warning"  href="<%=request.getContextPath()%>/login"><strong>Sign In</strong></a> 
                                            <a class="btn btn-sm btn-success"  href="<%=request.getContextPath()%>/users"><strong>Register</strong></a>
                                        </c:if>
